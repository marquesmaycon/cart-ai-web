...
export function ChatSidebar({ isOpen, onToggle }: ConversationSidebarProps) {
  const chats = useSWR("/api/chats", () => getChatSessions())
  ...
  return (
    <>
      {/* Overlay for mobile */}
      {isOpen && (
        <div className="fixed inset-0 bg-[#0005] z-40" onClick={onToggle} />
      )}
